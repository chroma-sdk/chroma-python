...
class Colors:
    ...
    CYAN = ChromaColor(red=0, green=255, blue=255)
    MAGENTA = ChromaColor(red=255, green=0, blue=255)
    SILVER = ChromaColor(red=192, green=192, blue=192)
    GREY = ChromaColor(red=128, green=128, blue=128)
    MAROON = ChromaColor(red=128, green=0, blue=0)
    OLIVE = ChromaColor(red=128, green=128, blue=0)
    GREEN = ChromaColor(red=0, green=128, blue=0)
